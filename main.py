...
__CHANNEL_USERNAME__ = "azraeldevschannel"
__GROUP_USERNAME__   = "cpmmodzchat"
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - t.me/Azraeldevs"
    colors = [
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: In order to tweak this account with CPMazraeldev.'))
