...
|  `----.   |  |         |  |  |  |     | | 
 \______|   | _|         |__|  |__|     |_| 
    ...
    _    _______    _   ___ _    ___  _____   _____ 
   /_\  |_  / _ \  /_\ | __| |  |   \| __\ \ / / __|
  / _ \  / /|   / / _ \| _|| |__| |) | _| \ V /\__ \
 /_/ \_\/___|_|_\/_/ \_\___|____|___/|___| \_/ |___/
...
from cpmazraeldevs import cpmazraeldevs

__CHANNEL_USERNAME__ = "Azraeldevs"
__GROUP_USERNAME__   = "cpmazraeldevs"
...
def banner(console):
    ...
    brand_name = figlet_format('CPM Devs', font='starwars')
    colors = [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = cpmazraeldevs(acc_access_key)
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝐀𝐳𝐫𝐚𝐞𝐥𝐃𝐞𝐯𝐬 ]==============='))
